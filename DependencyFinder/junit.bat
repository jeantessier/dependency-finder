...
"%JAVA_HOME%\bin\java" %DEPENDENCYFINDER_OPTS% -DDEPENDENCYFINDER_TESTS_VALIDATE=%DF_VALIDATE% -classpath %DEPENDENCYFINDER_HOME%\classes;%DEPENDENCYFINDER_HOME%\src;%DEPENDENCYFINDER_HOME%\tests;%DEPENDENCYFINDER_HOME%\lib\log4j.jar;%DEPENDENCYFINDER_HOME%\lib\jakarta-oro.jar;%JUNIT_HOME%\junit.jar;%FITLIBRARY_HOME%\fitlibraryRunner.jar junit.swingui.TestRunner %DEPENDENCYFINDER_CMD_LINE_ARGS%
goto doneRun
:noConsole
start "JUnit" "%JAVA_HOME%\bin\javaw" %DEPENDENCYFINDER_OPTS% -DDEPENDENCYFINDER_TESTS_VALIDATE=%DF_VALIDATE% -classpath %DEPENDENCYFINDER_HOME%\classes;%DEPENDENCYFINDER_HOME%\src;%DEPENDENCYFINDER_HOME%\tests;%DEPENDENCYFINDER_HOME%\lib\log4j.jar;%DEPENDENCYFINDER_HOME%\lib\jakarta-oro.jar;%JUNIT_HOME%\junit.jar;%FITLIBRARY_HOME%\fitlibraryRunner.jar junit.swingui.TestRunner %DEPENDENCYFINDER_CMD_LINE_ARGS%
:doneRun
