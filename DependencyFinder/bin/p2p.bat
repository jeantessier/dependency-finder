...
%JAVA_HOME%\bin\java %DEPENDENCYFINDER_OPTS% -Dlog4j.configuration=file:///%DEPENDENCYFINDER_HOME%/etc/log4j.properties -classpath %DEPENDENCYFINDER_HOME%\lib\DependencyFinder.jar;%DEPENDENCYFINDER_HOME%\lib\log4j-core.jar;%DEPENDENCYFINDER_HOME%\lib\jakarta-oro-2.0.4.jar;%DEPENDENCYFINDER_HOME%\lib\xerces.jar com.jeantessier.dependencyfinder.cli.DependencyReporter -p2p %DEPENDENCYFINDER_CMD_LINE_ARGS%
