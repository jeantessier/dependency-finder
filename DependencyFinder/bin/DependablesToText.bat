...
%JAVA_HOME%\bin\java %DEPENDENCYFINDER_OPTS% -classpath %DEPENDENCYFINDER_HOME%\lib\xerces.jar;%DEPENDENCYFINDER_HOME%\lib\xml-apis.jar;%DEPENDENCYFINDER_HOME%\lib\xalan.jar org.apache.xalan.xslt.Process -xsl %DEPENDENCYFINDER_HOME%\etc\DependablesToText.xsl %DEPENDENCYFINDER_CMD_LINE_ARGS%
