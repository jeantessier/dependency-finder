...
%JAVA_HOME%\bin\java %DEPENDENCYFINDER_OPTS% -classpath %DEPENDENCYFINDER_HOME%\classes;%DEPENDENCYFINDER_HOME%\lib\DependencyFinder.jar;%DEPENDENCYFINDER_HOME%\lib\log4j-1.2alpha6.jar;%DEPENDENCYFINDER_HOME%\lib\jakarta-oro-2.0.4.jar com.jeantessier.dependencyfinder.cli.ClassList %DEPENDENCYFINDER_CMD_LINE_ARGS%
