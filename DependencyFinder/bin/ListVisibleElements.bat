...
%JAVA_HOME%\bin\javadoc %DEPENDENCYFINDER_OPTS% -docletpath %DEPENDENCYFINDER_HOME%\lib\DependencyFinder.jar -doclet com.jeantessier.diff.ListVisibleElements %DEPENDENCYFINDER_CMD_LINE_ARGS%
