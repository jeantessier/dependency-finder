...
%JAVA_HOME%\bin\javadoc %DEPENDENCYFINDER_OPTS% -docletpath %DEPENDENCYFINDER_HOME%\lib\DependencyFinder.jar -doclet com.jeantessier.diff.ListDocumentedElements %DEPENDENCYFINDER_CMD_LINE_ARGS%
