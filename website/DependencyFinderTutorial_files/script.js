...
var ENDSHOW_MESG="End of slide show, click to exit.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=34, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   ...
   new hrefList("slide0039.htm", 1, 10),
   new hrefList("slide0013.htm", 1, 11),
   new hrefList("slide0014.htm", 1, 12),
   new hrefList("slide0011.htm", 1, 13),
   new hrefList("slide0012.htm", 1, 14),
   new hrefList("slide0033.htm", 1, 15),
   new hrefList("slide0017.htm", 1, 16),
   new hrefList("slide0018.htm", 1, 17),
   new hrefList("slide0040.htm", 1, 18),
   ...
   new hrefList("slide0024.htm", 1, 23),
   new hrefList("slide0025.htm", 1, 24),
   new hrefList("slide0026.htm", 1, 25),
   new hrefList("slide0027.htm", 1, 26),
   new hrefList("slide0029.htm", 1, 27),
   new hrefList("slide0028.htm", 1, 28),
   new hrefList("slide0034.htm", 1, 29),
   new hrefList("slide0035.htm", 1, 30),
   new hrefList("slide0036.htm", 1, 31),
   new hrefList("slide0037.htm", 1, 32),
   new hrefList("slide0038.htm", 1, 33),
   new hrefList("slide0030.htm", 1, 34)
);
